...
export default function ManageFAQLayout() {
  ...
  const fetchFooter = async () => {
    ...
    setFaq(response.data.items[0].FooterContentFAQ);
    setIsClient(true);
  };

  const handleSave = async () => {
    const request = {
      FooterContentFAQ: faq,
    };
            ...
            <div role="tablist" className="tabs tabs-lifted tabs-lg">
              ...
              >
                <div className="flex justify-between place-content-center">
                  <p className="flex flex-1 text-2xl">Frequently Asked Question</p>
                  <Button
