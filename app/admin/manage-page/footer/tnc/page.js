...
export default function ManageTnCLayout() {
  ...
  const fetchFooter = async () => {
    ...
    setTerm(response.data.items[0].FooterContentTermAndCondition);
    setIsClient(true);
  };

  const handleSave = async () => {
    const request = {
      FooterContentTermAndCondition: term,
    };
            ...
            <div role="tablist" className="tabs tabs-lifted tabs-lg">
              ...
              >
                <div className="flex justify-between place-content-center">
                  <p className="flex flex-1 text-2xl">Terms & Conditions</p>
                  <Button
