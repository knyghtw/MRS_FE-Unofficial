...
export default function RegisterLayout() {
  ...
  useEffect(() => {
    ...
    console.log("passNotMatch: " + passNotMatch);    
    console.log("usernameTouched: " + usernameTouched);

    if (!isShortUser && password?.length >= 8 && password2?.length >= 8 && !doPassNotMatch) {
      setIsSubmit(false);
    } else {
      setIsSubmit(true);
    }    
          ...
          <form className="self-center px-10">
            ...
            <div className="py-2">
              ...
              <Input
                ...
                className={usernameTouched && shortUsername ? ("border-red bg-gray-200"): ("border-black bg-gray-200")}
                value={username}
            ...
            {usernameTouched && shortUsername ? (<p className="text-red py-1">Panjang username kurang dari 4 huruf</p>) : (<></>)}
            <div className="py-2">
              <p>Password</p>
              <Input
                name="password"
                ...
                onRight={true}
                className={passNotMatch ? ("border-red bg-gray-200") : ("border-black bg-gray-200")}
                svg={
                  <button
                    type="button"
            ...
            {passNotMatch ? (<p className="text-red py-1">Password tidak cocok</p>) : (<></>)}            
            <div className="py-2">
              <p>Ulangi password</p>
              <Input
                name="password2"
